...
//
// Revision 2.1  1997/09/21 19:22:20  houghton
// Changed version to 2
//
// Revision 1.1  1997/07/19 12:52:41  houghton
// Initial Version (work in progess).
//
// Revision 1.3  1996/08/16  18:35:56  ichudov
// phase 2b
//
// Revision 1.2  1996/07/29  14:23:17  rjankir
...
// trunk.
//
// Revision 1.1  1995/08/29  22:17:59  ichudov
// Caribbean loading.
//
...
Bool
CARNpaNxxDeltaSybase::next(void)
{
  int NPA, NXX;
...
// cout << "Query = " << endl << Query << endl;
  ...
  Ret_Status ret = SybocExec(&syb, "CARNpaNxxDeltaSybase", 0, 0, Query,
...
// cout << "effDateStr =" << effDateStr << ", effDate =" << effDate << endl;
...
ostream & operator << (ostream & dest, const CARNpaNxxDeltaSybase & input)
{
...
const char *
CARNpaNxxDeltaSybase::getClassName( void ) const
{
  return( "CARNpaNxxDeltaSybase" );
}

// good - return TRUE if no detected errors
Bool
CARNpaNxxDeltaSybase::good( void ) const
{
...
const char *
CARNpaNxxDeltaSybase::error( void ) const
{
  static Str errStr;
  errStr.reset();
